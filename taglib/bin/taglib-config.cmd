...
:doit
if /i "%1#" == "--libs#"    echo -LE:/taglib-1.11.1/taglib/lib -llibtag
if /i "%1#" == "--cflags#"  echo -IE:/taglib-1.11.1/taglib/include/taglib
if /i "%1#" == "--version#" echo 1.11.1
if /i "%1#" == "--prefix#"  echo E:/taglib-1.11.1/taglib
